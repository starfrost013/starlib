...
public static class SDL_net
{
    ...
    /// </summary>
    /// <remarks>
    ///     Specifies SDL2_net.dll everywhere; will be mapped via 
    ///     .config for mono.
    /// </remarks>
    private const string SDL_NET_NATIVE_LIBRARY = "SDL2_net.dll";
    ...
    {
        SDL_version sdlVersion = new SDL_version();
    ...
    {
        return (SDL_version)Marshal.PtrToStructure(
    ...
    {
        SDL_net.SDLNet_GenericSocket genericSocket = (SDL_net.SDLNet_GenericSocket)Marshal.PtrToStructure(sock, typeof(SDL_net.SDLNet_GenericSocket));
        return SDL_net.SDLNet_AddSocket(set, genericSocket);
    }
    ...
    {
        SDL_net.SDLNet_GenericSocket genericSocket = (SDL_net.SDLNet_GenericSocket)Marshal.PtrToStructure(sock, typeof(SDL_net.SDLNet_GenericSocket));
        SDL_net.SDLNet_DelSocket(set, genericSocket);
    }
